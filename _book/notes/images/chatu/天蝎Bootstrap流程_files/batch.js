...
Confluence.Templates.ManageWatchers.dialogContent = function(opt_data, opt_ignored) {
  return '<div class="aui-group"><div class="aui-item page-watchers"><h3>' + soy.$$escapeHtml("\u5173\u6ce8\u672c\u9875\u9762") + '</h3><p>' + soy.$$escapeHtml("\u8fd9\u4e9b\u7528\u6237\u5f53\u9875\u9762\u53d8\u66f4\u4f1a\u83b7\u5f97\u901a\u77e5\u3002 \u53ef\u4ee5\u5bf9\u5217\u8868\u4e2d\u7684\u7528\u6237\u8fdb\u884c\u6dfb\u52a0\u548c\u5220\u9664\u3002") + '</p>' + Confluence.Templates.ManageWatchers.addWatcherForm({pageId: opt_data.pageId, xsrfToken: opt_data.xsrfToken, notificationType: 'page'}) + '<ul class="user-list"><li class="loading">' + soy.$$filterNoAutoescape("\u52a0\u8f7d\u2026") + '</li><li class="no-users hidden">' + soy.$$escapeHtml("\u65e0\u9875\u9762\u5173\u6ce8\u4eba") + '</li></ul></div><div class="aui-item space-watchers"><h3>' + soy.$$escapeHtml("\u5173\u6ce8\u672c\u9875\u9762") + '</h3><p>' + soy.$$escapeHtml("\x3d\u8fd9\u4e9b\u7528\u6237\u5f53\u7a7a\u95f4\u5185\u5bb9\u53d8\u66f4\u4f1a\u83b7\u5f97\u901a\u77e5\u3002 \u53ef\u4ee5\u6539\u53d8\u5217\u8868\u8bbe\u7f6e\u3002") + '</p>' + Confluence.Templates.ManageWatchers.addWatcherForm({pageId: opt_data.pageId, xsrfToken: opt_data.xsrfToken, notificationType: 'space'}) + '<ul class="user-list"><li class="loading">' + soy.$$filterNoAutoescape("\u52a0\u8f7d\u2026") + '</li><li class="no-users hidden">' + soy.$$escapeHtml("\u65e0\u7a7a\u95f4\u5173\u6ce8\u4eba") + '</li></ul></div></div>';
};
if (goog.DEBUG) {
...
e.toggleClass("selected ie-page-favourite-selected",!a);var b=!a?"\u4ece\u6536\u85cf\u4e2d\u79fb\u9664":"\u6dfb\u52a0\u6536\u85cf",b=b+(" ("+"f"+")"),c=!a?d.format("\u5220\u9664\u6536\u85cf","<u>","</u>"):d.format("\u6536\u85cf\u5939","<u>","</u>");e.children("span").empty().append(f).append(" ").append(c);e.attr("title",b);f.toggleClass("aui-iconfont-unstar",a);f.toggleClass("aui-iconfont-star",!a);e.removeClass("waiting");
...
-1,u=function(c){for(var b=a("span").addClass("item-action"),c=c.keys[0],d=0;d<c.length;d++){d>0&&b.append(p("\u7136\u540e"));for(var e=b,h=c[d].split("+"),g=0;g<h.length;g++){g>0&&e.append(p("+"));for(var i=e,j=h[g].split(".."),f=0;f<j.length;f++){f>0&&i.append(p("\u5f80"));i.append(t(j[f]))}}}return b},t=function(c){var b=a("kbd");switch(c){case "Shift":case "Sh":b.text("Shift");b.addClass("modifier-key");
...
aui.labels.closeIconText = function(opt_data, opt_ignored) {
  return '' + ((opt_data.closeIconText) ? soy.$$escapeHtml(opt_data.closeIconText) : '(' + soy.$$escapeHtml("\u5220\u9664") + ' ' + soy.$$escapeHtml(opt_data.text) + ')');
};
if (goog.DEBUG) {
...
" "+this.classNames.EDIT_ROW);this.trigger(this._event.RENDER,this.$el,a.values);this.$el.trigger(this._event.CONTENT_REFRESHED,[this.$el]);return this},renderOperations:function(a){var b=(0,c.default)('<td class="aui-restfultable-operations" />');a?b.append((0,c.default)('<input class="aui-button" type="submit" />').attr({accesskey:this.submitAccessKey,value:"\u66f4\u65b0"})).append((0,c.default)('<a class="aui-button aui-button-link" href="#" />').addClass(this.classNames.CANCEL).text("\u53d6\u6d88").attr({accesskey:this.cancelAccessKey})):
b.append((0,c.default)('<input class="aui-button" type="submit" />').attr({accesskey:this.submitAccessKey,value:"\u6dfb\u52a0"}));return b.add((0,c.default)('<td class="aui-restfultable-status" />').append((0,o.default)()))}});return g=g["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
"\u6b63\u5728\u8bfb\u53d6"}}});g.ClassNames=r.default;g.CustomCreateView=k.default;g.CustomEditView=h.default;g.CustomReadView=j.default;g.DataKeys=s.default;g.EditRow=t.default;g.EntryModel=p.default;g.Events=u.default;g.Row=q.default;g.Throbber=v.default;(0,w.default)("RestfulTable",g);m.default=g;return m=m["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
